      ...
      <div className="our_projects sec-pad-all">
        <div className="container">
          <div className="heading">
            ...
            <h2>Our Projects</h2>
            <p>
              Extreme heat is the deadliest climate hazard and it’s only getting
              worse. In communities without access to electricity or reliable
              cooling, heat can be life-threatening. At MEER, we provide simple,
              low-cost, and sustainable solutions that bring immediate relief
              while contributing to long-term climate balance.
            </p>
          </div>
