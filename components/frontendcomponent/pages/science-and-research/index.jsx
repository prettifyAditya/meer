          ...
          <div className="container">
            <div className="main_wrapper flex">
              ...
              >
                <ImageCompare />
                <h4>
                  Infrared View: MEER reflectors stay significantly cooler
                </h4>
              </motion.figure>
              <motion.figcaption
                initial={{ opacity: 0, x: -50 }}
              ...
              >
                <div className="heading">
                  <h2>
                    MEER’s work addresses both sides of this radiative equation.
                  </h2>
                </div>
                <div className="desc">
                  <p>
                    First, we increase shortwave reflectivity (albedo), sending
                    more incoming solar radiation back upward before it can be
                    absorbed and converted into heat. Our reflector materials
                    are engineered with very high albedo values (0.85+),
                    dramatically reducing surface heat gain.
                  </p>
                  <p>
                    Second, we develop and test passive daytime radiative
                    cooling (PDRC) materials. These advanced surfaces are
                    designed not only to reflect sunlight, but also to
                    efficiently emit longwave infrared radiation through the
                    atmospheric transparency window (8–13 microns), allowing
                    heat to escape directly to outer space — even under direct
                    sunlight.
                  </p>
                  <p>
                    Together, high shortwave reflectivity and enhanced longwave
                    emissivity form a complementary passive cooling strategy.
                    One prevents solar energy from entering the system; the
                    other accelerates the release of thermal energy back to
                    space.
                  </p>
                  <p>
                    These processes require no electricity, no refrigerants, and
                    no moving parts. They produce no operational emissions and
                    deliver immediate temperature reductions in buildings,
                    public spaces, and agricultural environments. At scale,
                    combining reflective and radiative cooling materials
                    contributes both to local heat protection and to the broader
                    goal of rebalancing Earth’s energy flow.
                  </p>
                </div>
              </motion.figcaption>
            </div>
