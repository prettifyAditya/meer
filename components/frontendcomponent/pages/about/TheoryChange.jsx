                ...
                >
                  <div className="theory_wrapper">
                    <div className="swiper-nav white center-full">
                      <SwiperButton
                        classname={`theory-prev-${item.id} swiper-prev`}
                      />
                      <SwiperButton
                        classname={`theory-next-${item.id} swiper-next`}
                      />
                    </div>
                    <Swiper
                      ref={swiperRef}
                      className={`theory_slider theory_slider-${item.id}`}
                      modules={[Navigation]}
                      speed={1000}
                      navigation={{
                        prevEl: `.theory-prev-${item.id}`,
                        nextEl: `.theory-next-${item.id}`,
                      }}
                      breakpoints={{
                        0: {
                          slidesPerView: 1.2,
                    ...
                    >
                      {item.theoryData.map((data) => (
                        <SwiperSlide key={data.id}>
                          <div className="theory_card">
                            <h6>{data.title}</h6>
                            <div
                              className="desc"
