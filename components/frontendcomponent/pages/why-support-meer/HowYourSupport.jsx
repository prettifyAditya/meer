          ...
          <div className="container">
            <Motion variant="fadeUp">
              ...
              <div className="get-in-touch">
                ...
                <p>
                  MEER prioritises{" "}
                  <strong>real-world deployment, evidence-building, </strong>{" "}
                  and <strong>shared learning, </strong> ensuring that lessons
                  from one location can inform solutions elsewhere.
                </p>
