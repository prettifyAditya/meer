    ...
    <section className="coolingMatters">
      <div className="left">
        ...
        <div className="website-content">
          <p>
            By reducing heat absorption at the surface, these systems can reduce
            heat stress for people today while contributing to broader effortsto
            reduce heat accumulation in built and managed environments over
            time.
          </p>
          <ul>
            <li>
