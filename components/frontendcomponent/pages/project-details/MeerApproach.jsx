      ...
      <div className="meer_approach sec-pad-all">
        <div className="container">
          <Motion variant="fadeUp">
            ...
            <div className="desc">
              <p>
                MEER has been operating in Sierra Leone since early 2023,
                focusing on passive cooling solutions that can immediately
                reduce indoor temperatures for households with no access to
                conventional cooling. MEER’s Freetown project demonstrates how
                simple, science-based interventions can deliver rapid relief in
              ...
              <p>
                ...
                creating a durable, low-cost cooling layer that can be applied
